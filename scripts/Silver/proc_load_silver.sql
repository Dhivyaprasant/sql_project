	...
	BEGIN TRY
		...
		FROM (
			...
			SELECT 
				...
				sls_cust_id,
				CASE
					WHEN sls_order_dt = 0 OR (sls_order_dt) != 8 THEN NULL
						ELSE CAST(CAST(sls_order_dt AS VARCHAR) AS date)
					END AS sls_order_dt,
				CASE WHEN sls_ship_dt = 0 OR (sls_ship_dt) != 8 THEN NULL
			...
			BEGIN CATCH
				PRINT'============================='
				PRINT'ERROR OCCURING DURING LOADING BRONZE AYER'
